...
from tensorflow.python.keras.backend import int_shape, sqrt, l2_normalize
...
from ..base_models.base_models import FacialRecognitionBase
...
class FaceNetBase(FacialRecognitionBase):
    ...
    def load_model(self, 
                   url: str = constants.DOWNLOAD_URL + "facenet_weights.h5") -> Model:
        ...
        if self.__class__.__name__ == "FaceNet128dClient":
            ...
            url = constants.DOWNLOAD_URL + "facenet512_weights.h5"
